...
function Home() {
  const [sidebarOpen, setSidebarOpen] = useState(false); // Initially set to false
                  ...
                  <Card className="flex h-full w-full max-w-[60rem] flex-row ml=15">
                    ...
                    <Card.Body className="p-4">
                      ...
                      <Typography className="mb-8 text-foreground">
                        ...
                        too early, despite having adequate opportunity to sleep.
                        It can be a temporary or chronic condition.
                      </Typography>
                      <Typography className="mt-5">
                        <strong>Slumbr</strong> can help you manage insomnia
                        based on your lifestyle and other factors that influence
                        your sleep quality. Please complete the assessment to
                        analyze changes in your lifestyle and to receive a
                        personalized recommendation on steps to get you sleeping
                        again!
                      </Typography>
                      ...
                      <Link to="/survey">
                        <Button
                          as="a"
                          href="#"
                          className="mb-2 mt-10 pl-3 flex w-fit items-right gap-4"
                        >
                          Begin Assessment
                          <svg
