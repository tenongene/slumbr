...
function Sidebar({
  ...
  return (
    <div className="min-w-fit">
      ...
      <div className={`fixed inset-0 bg-gray-900/30 z-40 lg:hidden transition-opacity duration-200 ${sidebarOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`} aria-hidden="true"></div>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                    ...
                    <React.Fragment>
                      ...
                      <a
                        ...
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
                          pathname === "/" || pathname.includes("") ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
              ...
              {/* Education */}
              <SidebarLinkGroup activecondition={pathname.includes("education")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
